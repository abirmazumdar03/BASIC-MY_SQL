...
#SHOW SAMPLE TABLE (WITH A NAME (VIEW NAME) ALIAS) AS OF HOW THE TABLE WILL LOOK LIKE AFTER THE MODIFIUCATION

#IF WE ACTUALLY WANT TO ADD THE FULL_NAME COLU,MN IN THE ACTUAL TABLE
