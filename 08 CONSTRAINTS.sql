#*************************UNIQUE , NOT NULL , CHECK , DEFAULT CONSTRAIN IN COLUMNS OF A TABLE*************************
...
ALTER TABLE BTECH_ADMISSION
ADD CONSTRAINT course_checker CHECK (COURSE IN ("CSE","BBA","BCA","LLB","PHRM","BCOM","BTECH","MBA","BA","MA"));
